...
// https://stackoverflow.com/questions/70086464/flutter-input-time-in-hhmmss-format-in-textformfield-or-textfield-without-usin
  ...
  TextEditingValue formatEditUpdate(
    ...
    if (_exp.hasMatch(newValue.text)) {
      ...
      if (value.length >= 8) {
        ...
        if (value.substring(0, 7) == '00:00:0') {
          leftChunk = '00:00:00'; // Changed from "" to current value.
          rightChunk = '';
        } else if (value.substring(0, 6) == '00:00:') {
          leftChunk = '00:00:0';
